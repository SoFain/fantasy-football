...
WHERE missing_flags_json IS NULL
   ...
   OR JSON_VALUE(missing_flags_json, '$.receiving_first_down_proxy_missing') IS NULL
   OR JSON_VALUE(missing_flags_json, '$.rushing_first_down_proxy_missing') IS NULL
   OR JSON_VALUE(missing_flags_json, '$.passing_first_down_proxy_missing') IS NULL
