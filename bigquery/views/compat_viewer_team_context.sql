-- Compatibility view for Viewer Team Lab.
-- Replaces future raw Sleeper joins in get_sleeper_viewer_team_context, app.py:3390-3570.
-- Backed by mart_viewer_team_context.
