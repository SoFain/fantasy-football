...
Status: **closed**. The debt this register tracked was direct raw/source BigQuery reads from the Streamlit UI and its chat surface. The Streamlit app was retired, so those read paths no longer exist.
