...
3. Trade and Value Analyzer
   ...
   - Enable `USE_COMPAT_TRADE_PLAYER_HISTORY=true`.
   - Run AI outlook for a selected trade and confirm the history helper path either supplies context or warns before fallback.
