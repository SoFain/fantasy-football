...
| `active_league_rosters` | deprecated/unknown | Prompt reference only (`app.py`, `src/pigskin_context_tools.py`); no writer found. | Not safe. |
| `historical_player_metrics` | deprecated/unknown | Prompt alias text (`app.py`, `src/pigskin_context_tools.py`); no writer found. | Not safe. |
