...
# Run manually: powershell -NoProfile -ExecutionPolicy Bypass -File "E:\Fantasy Football\.claude\worktrees\pigskin-cloud-docs-status-7a2282\scripts\daily_pigskin_chain.ps1"

$ErrorActionPreference = 'Stop'
$root = 'E:\Fantasy Football'
$branchRoot = 'E:\Fantasy Football\.claude\worktrees\pigskin-cloud-docs-status-7a2282'
