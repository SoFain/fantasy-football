"""Deploy the review-only Pigskin-vs-market context view.

Market context is quotable evidence for articles and show prep. It is never a
formula input: no candidate view, promoter, or unified-board builder may read it.
"""
...
VIEW_FILES = ("v_market_rankings_context.sql",)
